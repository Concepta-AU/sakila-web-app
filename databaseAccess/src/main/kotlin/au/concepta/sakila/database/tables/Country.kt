...
import au.concepta.sakila.database.keys.COUNTRY_PKEY
...
open class Country(
     ...
     */
    val COUNTRY_: TableField<CountryRecord, String?> = createField(DSL.name("country"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.country.last_update</code>.
     */
    val LAST_UPDATE: TableField<CountryRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
