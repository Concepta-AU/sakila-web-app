...
import au.concepta.sakila.database.indexes.IDX_FK_FILM_ID
import au.concepta.sakila.database.keys.FILM_ACTOR_PKEY
...
open class FilmActor(
     ...
     */
    val ACTOR_ID: TableField<FilmActorRecord, Int?> = createField(DSL.name("actor_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.film_actor.film_id</code>.
     */
    val FILM_ID: TableField<FilmActorRecord, Int?> = createField(DSL.name("film_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.film_actor.last_update</code>.
     */
    val LAST_UPDATE: TableField<FilmActorRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
