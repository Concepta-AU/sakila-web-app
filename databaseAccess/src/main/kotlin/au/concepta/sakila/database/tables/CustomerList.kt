...
import au.concepta.sakila.database.tables.records.CustomerListRecord
...
open class CustomerList(
     ...
     */
    val ADDRESS: TableField<CustomerListRecord, String?> = createField(DSL.name("address"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.customer_list.zip code</code>.
     */
    val `ZIP CODE`: TableField<CustomerListRecord, String?> = createField(DSL.name("zip code"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.customer_list.phone</code>.
     */
    val PHONE: TableField<CustomerListRecord, String?> = createField(DSL.name("phone"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.customer_list.city</code>.
     */
    val CITY: TableField<CustomerListRecord, String?> = createField(DSL.name("city"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.customer_list.country</code>.
     */
    val COUNTRY: TableField<CustomerListRecord, String?> = createField(DSL.name("country"), SQLDataType.CLOB, this, "")
     ...
     */
    val SID: TableField<CustomerListRecord, Int?> = createField(DSL.name("sid"), SQLDataType.INTEGER, this, "")
