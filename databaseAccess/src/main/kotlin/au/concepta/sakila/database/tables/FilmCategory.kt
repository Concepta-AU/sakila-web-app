...
import au.concepta.sakila.database.keys.FILM_CATEGORY_PKEY
import au.concepta.sakila.database.keys.FILM_CATEGORY__FILM_CATEGORY_CATEGORY_ID_FKEY
...
open class FilmCategory(
     ...
     */
    val FILM_ID: TableField<FilmCategoryRecord, Int?> = createField(DSL.name("film_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.film_category.category_id</code>.
     */
    val CATEGORY_ID: TableField<FilmCategoryRecord, Int?> = createField(DSL.name("category_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.film_category.last_update</code>.
     */
    val LAST_UPDATE: TableField<FilmCategoryRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
