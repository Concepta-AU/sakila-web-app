...
import au.concepta.sakila.database.tables.records.StaffListRecord
...
open class StaffList(
     ...
     */
    val ID: TableField<StaffListRecord, Int?> = createField(DSL.name("id"), SQLDataType.INTEGER, this, "")
     ...
     */
    val ADDRESS: TableField<StaffListRecord, String?> = createField(DSL.name("address"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.staff_list.zip code</code>.
     */
    val `ZIP CODE`: TableField<StaffListRecord, String?> = createField(DSL.name("zip code"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.staff_list.phone</code>.
     */
    val PHONE: TableField<StaffListRecord, String?> = createField(DSL.name("phone"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.staff_list.city</code>.
     */
    val CITY: TableField<StaffListRecord, String?> = createField(DSL.name("city"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.staff_list.country</code>.
     */
    val COUNTRY: TableField<StaffListRecord, String?> = createField(DSL.name("country"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.staff_list.sid</code>.
     */
    val SID: TableField<StaffListRecord, Int?> = createField(DSL.name("sid"), SQLDataType.INTEGER, this, "")
