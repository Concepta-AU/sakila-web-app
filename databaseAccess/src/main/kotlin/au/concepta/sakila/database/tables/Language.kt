...
import au.concepta.sakila.database.keys.LANGUAGE_PKEY
...
open class Language(
     ...
     */
    val LAST_UPDATE: TableField<LanguageRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
