...
import au.concepta.sakila.database.indexes.IDX_STORE_ID_FILM_ID
import au.concepta.sakila.database.keys.INVENTORY_PKEY
...
open class Inventory(
     ...
     */
    val FILM_ID: TableField<InventoryRecord, Int?> = createField(DSL.name("film_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.inventory.store_id</code>.
     */
    val STORE_ID: TableField<InventoryRecord, Int?> = createField(DSL.name("store_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.inventory.last_update</code>.
     */
    val LAST_UPDATE: TableField<InventoryRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
