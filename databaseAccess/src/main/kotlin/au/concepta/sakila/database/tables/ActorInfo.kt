...
import au.concepta.sakila.database.tables.records.ActorInfoRecord
...
open class ActorInfo(
     ...
     */
    val FIRST_NAME: TableField<ActorInfoRecord, String?> = createField(DSL.name("first_name"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.actor_info.last_name</code>.
     */
    val LAST_NAME: TableField<ActorInfoRecord, String?> = createField(DSL.name("last_name"), SQLDataType.CLOB, this, "")
