...
import au.concepta.sakila.database.indexes.IDX_ACTOR_LAST_NAME
import au.concepta.sakila.database.keys.ACTOR_PKEY
import au.concepta.sakila.database.keys.FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY
import au.concepta.sakila.database.tables.Film.FilmPath
...
open class Actor(
     ...
     */
    val ACTOR_ID: TableField<ActorRecord, Int?> = createField(DSL.name("actor_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "")

    /**
     * The column <code>public.actor.first_name</code>.
     */
    val FIRST_NAME: TableField<ActorRecord, String?> = createField(DSL.name("first_name"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.actor.last_name</code>.
     */
    val LAST_NAME: TableField<ActorRecord, String?> = createField(DSL.name("last_name"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.actor.last_update</code>.
     */
    val LAST_UPDATE: TableField<ActorRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
    ...
    override fun getIdentity(): Identity<ActorRecord, Int?> = super.getIdentity() as Identity<ActorRecord, Int?>
