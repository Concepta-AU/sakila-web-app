...
import au.concepta.sakila.database.indexes.IDX_FK_COUNTRY_ID
import au.concepta.sakila.database.keys.ADDRESS__ADDRESS_CITY_ID_FKEY
import au.concepta.sakila.database.keys.CITY_PKEY
import au.concepta.sakila.database.keys.CITY__CITY_COUNTRY_ID_FKEY
import au.concepta.sakila.database.tables.Address.AddressPath
import au.concepta.sakila.database.tables.Country.CountryPath
...
open class City(
     ...
     */
    val CITY_: TableField<CityRecord, String?> = createField(DSL.name("city"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.city.country_id</code>.
     */
    val COUNTRY_ID: TableField<CityRecord, Int?> = createField(DSL.name("country_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.city.last_update</code>.
     */
    val LAST_UPDATE: TableField<CityRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
