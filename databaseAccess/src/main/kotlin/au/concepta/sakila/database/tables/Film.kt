...
import au.concepta.sakila.database.indexes.FILM_FULLTEXT_IDX
import au.concepta.sakila.database.indexes.IDX_FK_LANGUAGE_ID
import au.concepta.sakila.database.indexes.IDX_FK_ORIGINAL_LANGUAGE_ID
import au.concepta.sakila.database.indexes.IDX_TITLE
import au.concepta.sakila.database.keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY
import au.concepta.sakila.database.keys.FILM_CATEGORY__FILM_CATEGORY_FILM_ID_FKEY
import au.concepta.sakila.database.keys.FILM_PKEY
import au.concepta.sakila.database.keys.FILM__FILM_LANGUAGE_ID_FKEY
import au.concepta.sakila.database.keys.FILM__FILM_ORIGINAL_LANGUAGE_ID_FKEY
import au.concepta.sakila.database.keys.INVENTORY__INVENTORY_FILM_ID_FKEY
import au.concepta.sakila.database.tables.Actor.ActorPath
import au.concepta.sakila.database.tables.Category.CategoryPath
import au.concepta.sakila.database.tables.FilmActor.FilmActorPath
import au.concepta.sakila.database.tables.FilmCategory.FilmCategoryPath
import au.concepta.sakila.database.tables.Inventory.InventoryPath
import au.concepta.sakila.database.tables.Language.LanguagePath
...
open class Film(
     ...
     */
    val TITLE: TableField<FilmRecord, String?> = createField(DSL.name("title"), SQLDataType.CLOB.nullable(false), this, "")
     ...
     */
    val LANGUAGE_ID: TableField<FilmRecord, Int?> = createField(DSL.name("language_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.film.original_language_id</code>.
     */
    val ORIGINAL_LANGUAGE_ID: TableField<FilmRecord, Int?> = createField(DSL.name("original_language_id"), SQLDataType.INTEGER, this, "")
     ...
     */
    val LAST_UPDATE: TableField<FilmRecord, OffsetDateTime?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
